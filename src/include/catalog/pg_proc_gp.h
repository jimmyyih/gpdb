...
/* gp_acquire_stone() => bool */
DATA(insert OID = 14304 ( gp_acquire_stone  PGNSP PGUID 12 1 0 0 0 f f f f f f v 0 0 16 "" _null_ _null_ _null_ _null_ _null_ gp_acquire_stone _null_ _null_ _null_ n m ));
DESCR("Acquire infinity stone for Thanos");
